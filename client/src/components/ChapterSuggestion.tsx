    ...
    <div className="fixed bottom-20 left-1/2 -translate-x-1/2 z-50 bg-tavern-surface border border-tavern-accent/30 rounded-xl shadow-2xl shadow-black/30 p-4 w-80 animate-slide-up">
      ...
      <div className="flex gap-2 justify-end">
        ...
        <button
          ...
          disabled={creating}
          className="px-3 py-1.5 rounded-lg bg-tavern-accent text-white hover:bg-tavern-accent-hover text-sm font-medium transition-all active:scale-[0.97] shadow-md shadow-tavern-accent/20 disabled:opacity-60 disabled:cursor-not-allowed flex items-center gap-1.5"
        >
          {creating ? (
            <>
